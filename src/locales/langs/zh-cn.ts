const local: App.I18n.Schema = {
  ...
  page: {
    ...
    workorder: {
      ...
      assignHandler: '指派处理人',
      evaluate: '评价',
      selectFactoryArea: '选择工厂/厂区',
      selectDevicePart: '选择设备/部件',
      orderTypes: {
        repair: '维修',
        maintenance: '保养',
        inspection: '巡检',
      ...
      confirmBatchDelete: '确定要批量删除选中的工单吗？此操作不可恢复。',
      confirmDelete: '确定要删除该工单吗？此操作不可恢复。',
      confirmCancel: '确定要取消该工单吗？',
      form: {
        orderCode: '请输入工单编号',
        orderType: '请选择工单类型',
        orderSource: '请选择工单来源',
        ...
        deviceId: '请选择设备',
        faultTime: '请选择故障时间',
        faultDescription: '请输入故障描述',
        repairRequirement: '请输入修复要求',
        assigneeId: '请选择指派处理人',
        planStartTime: '请选择计划开始时间',
        planEndTime: '请选择计划完成时间',
        handleDuration: '请输入处理耗时',
        repairResult: '请输入维修结果',
        repairCost: '请输入维修费用',
        spareParts: '请输入更换备件',
        reviewResult: '请输入审核结果',
        evaluationScore: '请选择评价分数',
        evaluationRemark: '请输入评价备注',
        remark: '请输入操作备注'
      }
    },
    workbench: {
      ...
      cancelled: '已取消',
      completionRate: '完成率',
      avgHandleDuration: '平均处理时长',
      avgEvaluationScore: '平均评分',
    ...
    equipment: {
      ...
      form: {
        ...
        deviceName: '请输入设备名称',
        deviceModel: '请输入设备型号',
        deviceStatus: '请选择设备状态',
        deviceSn: '请输入设备序列号',
        manufacturer: '请输入制造商',
        installTime: '请选择安装时间',
        startUseTime: '请选择启用时间',
        maintainCycle: '请输入维护周期',
        lastMaintainTime: '请选择上次维护时间',
