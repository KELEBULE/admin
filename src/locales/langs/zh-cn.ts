const local: App.I18n.Schema = {
  ...
  page: {
    ...
    monitor: {
      ...
      selectDate: '请选择日期',
      deviceAlarm: '设备报警',
      deviceWorkOrder: '设备工单',
      runningDuration: '运行时长',
      monitorData: '监测数据',
      frequentAlarmParts: '频繁报警部件',
      frequentAlarmTime: '频繁告警时间',
      frequentAlarmLevel: '频繁报警等级',
      temperatureTrend: '检测温度趋势',
      dailyAlarmTrend: '报警数量日趋势',
      alarmTemperatureTrend: '报警温度趋势',
      hourlyAlarmDistribution: '历史报警时间分布',
      alarmCount: '报警次数',
      temperature: '温度',
      alarmRecord: '报警记录'
    },
    ...
    workbench: {
      ...
      minute: '分钟',
      noData: '暂无数据',
      alarmLevelDistribution: '报警等级分布',
      deviceAlarmTop: '设备报警TOP排行',
    ...
    equipment: {
      ...
      batchScrap: '批量报废',
      confirmBatchScrap: '确定要批量报废选中的设备吗？报废后设备状态将变为停用。',
      batchEditStatus: '批量修改状态',
      confirmBatchEditStatus: '确定要批量修改选中设备的状态吗？',
      selectStatus: '请选择状态',
      scrapSuccess: '报废成功',
      editStatusSuccess: '状态修改成功',
