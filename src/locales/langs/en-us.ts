const local: App.I18n.Schema = {
  ...
  page: {
    ...
    workbench: {
      workOrder: 'Work Order Statistics',
      ...
      avgHandleDuration: 'Avg Handle Duration',
      ...
      deviceAlarmTop: 'Device Alarm Top Ranking',
    ...
    equipment: {
      ...
      startUseTime: 'Start Use Time',
      totalWorkHours: 'Total Work Hours',
      maintainCycle: 'Maintain Cycle',
      lastMaintainTime: 'Last Maintain Time',
      ...
      form: {
        ...
        factoryAddress: 'Please enter factory address',
        contactPerson: 'Please enter contact person',
        contactPhone: 'Please enter contact phone',
        status: 'Please select status',
        locationCode: 'Please enter location code',
        areaName: 'Please enter area name',
        areaStatus: 'Please select area status',
        areaOrder: 'Please enter order',
        deviceCode: 'Please enter device code',
        deviceName: 'Please enter device name',
        deviceModel: 'Please enter device model',
        deviceStatus: 'Please select device status',
        deviceSn: 'Please enter device SN',
        manufacturer: 'Please enter manufacturer',
        installTime: 'Please select install time',
        startUseTime: 'Please select start use time',
        maintainCycle: 'Please enter maintain cycle',
        lastMaintainTime: 'Please select last maintain time',
        warrantyPeriod: 'Please enter warranty period',
        deviceNote: 'Please enter note',
    ...
    workorder: {
      ...
      priority: 'Priority',
      deviceId: 'Device ID',
      devicePart: 'Device/Part',
      deviceName: 'Device Name',
      deviceCode: 'Device Code',
      alarmId: 'Alarm ID',
      faultTime: 'Fault Time',
      faultDescription: 'Fault Description',
      repairRequirement: 'Repair Requirement',
      ...
      handleDuration: 'Handle Duration (min)',
      ...
      evaluationRemark: 'Evaluation Remark',
      ...
      evaluate: 'Evaluate',
      selectFactoryArea: 'Select Factory/Area',
      ...
      confirmBatchDelete: 'Are you sure to delete selected work orders? This action cannot be undone.',
      confirmDelete: 'Are you sure to delete this work order? This action cannot be undone.',
      confirmCancel: 'Are you sure to cancel this work order?',
      form: {
        orderCode: 'Please enter order code',
        orderType: 'Please select order type',
        orderSource: 'Please select order source',
        orderStatus: 'Please select order status',
        priority: 'Please select priority',
        deviceId: 'Please select device',
        faultTime: 'Please select fault time',

        faultDescription: 'Please enter fault description',
        repairRequirement: 'Please enter repair requirement',
        assigneeId: 'Please select assignee',
        planStartTime: 'Please select plan start time',
        planEndTime: 'Please select plan end time',
        handleDuration: 'Please enter handle duration',
        repairResult: 'Please enter repair result',
        repairCost: 'Please enter repair cost',
        spareParts: 'Please enter spare parts',
        reviewResult: 'Please enter review result',
        evaluationScore: 'Please select evaluation score',
        evaluationRemark: 'Please enter evaluation remark',
        remark: 'Please enter remark'
      }
    }
  },
