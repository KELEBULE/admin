    ...
    type Schema = {
      ...
      page: {
        ...
        monitor: {
          ...
          selectDate: string;
          deviceAlarm: string;
          deviceWorkOrder: string;
          runningDuration: string;
          monitorData: string;
          frequentAlarmParts: string;
          frequentAlarmTime: string;
          frequentAlarmLevel: string;
          temperatureTrend: string;
          dailyAlarmTrend: string;
          alarmTemperatureTrend: string;
          hourlyAlarmDistribution: string;
          alarmCount: string;
          temperature: string;
          alarmRecord: string;
        };
        ...
        equipment: {
          ...
          confirmBatchDeleteFactory: string;
          confirmBatchDeleteArea: string;
          confirmBatchDeleteDevice: string;
          confirmDeleteDevice: string;
          batchScrap: string;
          confirmBatchScrap: string;
          batchEditStatus: string;
          confirmBatchEditStatus: string;
          selectStatus: string;
          scrapSuccess: string;
          editStatusSuccess: string;
        ...
        workorder: {
          ...
          evaluate: string;
          selectFactoryArea: string;
          selectDevicePart: string;
          orderTypes: {
            repair: string;
            maintenance: string;
            inspection: string;
